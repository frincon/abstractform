...
public class FTable extends FField implements IFTable {
	...
	public FTable(String id, String name) {
		super(id, name);
		setType(TableConstants.TYPE_TABLE);
		setPageLenght(DEFAULT_PAGE_LENGTH);
		setExtra(TableConstants.EXTRA_TABLE_FIELD_LIST, tableFieldList);
	...
	public void setPageLenght(int pageLenght) {
		setExtra(TableConstants.EXTRA_TABLE_PAGE_LENGHT, pageLenght);
	}

	public int getPageLenght() {
		return (Integer) getExtra(TableConstants.EXTRA_TABLE_PAGE_LENGHT);
	}
