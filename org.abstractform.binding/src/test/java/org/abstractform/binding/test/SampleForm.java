...
public class SampleForm extends BFForm<BusinessPartner, BusinessPartner> {
	...
	public final BFSelector F_ORGANIZACION = SF_MAIN
			.addField(0, 1, "fOrganization", "Organizacion", BusinessPartner.PROPERTY_ORGANIZATION, BFSelector.class)
			.description("The organization").displayWidth(40).readOnly(false).required(true)
			.selectorProviderFactory(organizationSPF);
	...
	public final BFField F_MAIL = SF_MORE_DATA.addField(0, 1, "gMail", "Mail", BusinessPartner.PROPERTY_MAIL)
			.description("The e-mail").readOnly(false).required(false).displayWidth(60).maxLength(60).required(false)
	...
	public final BFTable FT_LOCATIONS = SF_LOCATIONS.addField(0, 0, null, "Locations",
			BusinessPartner.PROPERTY_BUSINESS_PARTNER_LOCATION_SET, BFTable.class);
