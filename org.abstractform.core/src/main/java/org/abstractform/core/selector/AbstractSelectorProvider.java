...
public abstract class AbstractSelectorProvider<T> implements SelectorProvider<T> {

	private CopyOnWriteArraySet<SelectorProviderListener> listenerList = new CopyOnWriteArraySet<SelectorProviderListener>();
	...
	protected void fireElementsChanged() {
		for (SelectorProviderListener listener : listenerList) {
